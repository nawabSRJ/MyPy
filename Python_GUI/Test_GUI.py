...
# *-----------------------------------------------------------------------------
# *---------------------- Code here for Second Window -----------------------------

# Define a function for the second window
def show_second_window():
    second_window = tk.Tk()
    second_window.geometry("400x300")
    second_window.title("Second Window")

    # Create a label in the second window
    label = tk.Label(second_window, text="This is the Second Window")
    label.pack(pady=20)
    
    button = tk.Button(text = "Click Me" , bg = "Purple")
  
    # Create a combo-box with three options
    combo_var = tk.StringVar()
    combo_box = ttk.Combobox(second_window, textvariable=combo_var)
    combo_box['values'] = ('Option 1', 'Option 2', 'Option 3')
    combo_box.pack()
    # Place other widgets or functionality as needed


# *---------------------- Code here for Third Window ------------------------------
# Define a function for the third window
def show_third_window():
    pass  # Add your code for the third window here
...
def show_window(window_name):
    ...
    # * this will pop second and third window :
    
    if window_name == "second":
        show_second_window()
    elif window_name == "third":
        show_third_window()
